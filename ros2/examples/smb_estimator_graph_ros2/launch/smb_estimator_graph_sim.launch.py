...
def generate_launch_description():
    ...
    smb_graph_param_file = os.path.join(pkg_dir, 'config', 'smb_specific', 'smb_graph_params.yaml')
    smb_extrinsic_param_file = os.path.join(pkg_dir, 'config', 'smb_specific', 'smb_extrinsic_params.yaml')
