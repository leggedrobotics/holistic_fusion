...
void FactorGraphFiltering::updateGraph() {
  ...
  while (ros::ok()) {
    ...
    if (optimizeGraph) {
      ...
      gtsam::NavState optimizedNavState = _graphMgr.updateGraphAndState();
