...
void CompslamSeRos::addToPathMsg(nav_msgs::PathPtr pathPtr, const std::string& frameName, const ros::Time& stamp, const Eigen::Vector3d& t,
...
void CompslamSeRos::addToOdometryMsg(nav_msgs::OdometryPtr msgPtr, const std::string& fixedFrame, const std::string& movingFrame,
  ...
  tf::poseTFToMsg(compslam_se::matrix4ToTf(T), msgPtr->pose.pose);
