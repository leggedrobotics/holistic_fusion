...
// Trigger functions -----------------------
bool GraphMsf::optimizeSlowBatchSmoother(int maxIterations, const std::string& savePath, const std::string& format) {
  return graphMgrPtr_->optimizeSlowBatchSmoother(maxIterations, savePath, format);
}
